...
if [ -f data/raw/conquerx-b05-lec01-digit-recognizer/train.csv ]; then
...
unzip data/raw/conquerx-b05-lec01-digit-recognizer.zip \
  -d data/raw/conquerx-b05-lec01-digit-recognizer

# Elimina el zip para liberar 7GB
rm data/raw/conquerx-b05-lec01-digit-recognizer.zip